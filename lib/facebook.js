...
exports.handler = argv => {
    ...
    if (argv.nopython) {
        nopythonHandler(inputFilePath, csv)
    } else {
        handler(inputFilePath, csv)
    }
...
function nopythonHandler(inputFilePath, csv) {
...
function handler() {
    ...
    cp.execSync('pip install -r requirements.txt', { env: process.env })
